...
#
# Created: Sat Sep 03 00:50:27 2016
...
class APMUi(object):
    def setupUi(self, MainWindow):
        ...
        self.label_12.setGeometry(QtCore.QRect(30, 40, 81, 31))
        ...
        #self._urllist_.activated[str].connect(self.changeurl1)
        # QtGui.QWidget.connect(self._urlBox_, QtCore.SIGNAL('activated()'), self.changeurl)
